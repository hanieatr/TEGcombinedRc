...
A = st.sidebar.number_input("$A_{leg}$ (m²)", 1e-8, 1e-4, 1e-6, step=1e-7, format="%.9f")
L = st.sidebar.number_input("$L_{leg}$ (m)", 0.000001, 1e-1, 0.001, step=0.000001, format="%.6f")
...
N = st.sidebar.number_input("$N_{leg}$", 1.0, 200.0, 127.0, step=1.0)
