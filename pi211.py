        ...
        if is_eq:
            with st.expander("Equations"):
                if is_eq:
                   ...
                   \Bigr] \\[10pt]
                &\quad + \dfrac{\eta_{\text{opt}} \text{CR}\,G}{
                     0.03968\,T_a 
            ...
            T_h &= T_c + \Biggl\lvert 
            \Biggl(
              \dfrac{A_{cp}\,\eta_{\text{opt}}\text{CR}\,G}{
                1.645\,\dfrac{A_{cp}}{L} 
                + 2.261\,G L_{\text{legs}} V \cdot A_{rc/cp}^{-0.2786^{17.843\,A_{cp}}}
              }
              + L_{\text{legs}}\,\eta_{\text{opt}}\,\text{CR}\,G 
              + 0.785\,\varepsilon_2 \tau_2 
                \sqrt{\tau_4 \sqrt{\dfrac{A_{cp}\,\varepsilon_4}{A_{\text{legs}} N_{\text{legs}}}}}
            \Biggr) 
            \\[12pt]
            &\quad \times \Biggl(
              -\sqrt{ 
                \dfrac{ A_{cp} \left(0.215 - 0.511 \dfrac{\alpha_{\text{rc}}}{A_{rc/cp}}\right) }{ 
                  A_{\text{legs}} (-A_{rc/cp} + N_{\text{legs}} + material + 2.17) \sqrt{|material - 4.145|} 
                } 
              }
              + 0.340 
              + \dfrac{0.0364}{
                \left( -\dfrac{material}{\sqrt{\dfrac{A_{cp}}{A_{\text{legs}} N_{\text{legs}}}} + 0.954} \right)^{\!material}
              }
